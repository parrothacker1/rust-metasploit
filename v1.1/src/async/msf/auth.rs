...
/// ## Example
/// ```
/// auth::logout(client.clone()).await.unwrap(); // true
/// ```
...
/// ## Example
/// ```
/// auth::add_token(client.clone,"newtoken").await.unwrap() // true
/// ```
...
/// ## Example
/// ```
/// auth::generate_token(client.clone()).await.unwrap(); //"newtoken"
/// ```
...
/// ## Example
/// ```
/// auth::list_token(client.clone()).await.unwrap(); // ["newtoken","<rpctoken>"]
/// ```
...
/// ## Example
/// ```
/// auth::remove_token(client.clone(),"newtoken").await.unwrap(); // true
/// ```
